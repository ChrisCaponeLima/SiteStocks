// /pages/index.vue - V4.2 - Substituição de texto por imagem no card principal

<script setup lang="ts">
import { ref, computed } from 'vue'

// Variável de estado para controlar a visibilidade dos valores (AJUSTE)
const showValues = ref(true) 

// Função para alternar a visibilidade (AJUSTE)
...
<div v-else class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
  ...
  <header class="text-center relative">
    <h1 class="text-3xl font-extrabold text-blue-900 mb-1">
      <span v-if="showValues">10.856,37</span>
      <span v-else>**********</span>
    </h1>
 ...
 <section class="grid grid-cols-1 sm:grid-cols-3 gap-4">
  ...
  <div class="relative z-10 h-full flex flex-col justify-end p-4 pb-10">
    ...
    <div class="flex justify-between items-center text-sm sm:text-base font-semibold">
            ...
            <p class="uppercase" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.7);">CIDA MIRANDA</p>
